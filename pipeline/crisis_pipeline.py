...
def dynamic_logic_warning(crisis_type, state):
    # Universal override for generic rescue cases in cities
    if crisis_type.lower() == "search & rescue":
        return None  # Allowed anywhere
    ...
    return None  # For crisis types like Medical, Food, etc.
...
if __name__ == "__main__":
    report = "Massive landslide near Rohini, Delhi. Families are trapped. Urgent rescue needed."
